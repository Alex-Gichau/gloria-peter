const gallery = () => {
  return (
    ...
    <div>
        {/* <div className="mb-4 flex items-center justify-between gap-4 sm:mb-8 md:mb-12"> */}
        <div>
            <div className="flex-col items-center gap-5">
                <h2 className="text-2xl font-bold text-gray-800 lg:text-3xl dark:text-white">Our Journey</h2>

                <p className="hidden max-w-screen-sm text-gray-500 dark:text-gray-300 md:block">
                    We thank God for the journey that we celebrate in this Season. We are deeply encouraged by your love and support.
                </p>
            </div>
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-3 md:gap-6 xl:gap-8">
            {/* <!-- image - start --> */}
            <a href="#"
